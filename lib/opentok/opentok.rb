...
module OpenTok
  class OpenTok
    ...
    # @option opts [Time] :expire_time (optional) The time when the token will expire. If you do not specify this value, tokens expire in 24 hours after being created.
    ...
    # @option opts [String] :data (optional) Added in OpenTok v0.91.20. A string containing metadata describing the connection.
